...
class CreateIntegrationsPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('integrations_payments', function (Blueprint $table) {
            $table->id();
                ...
                $table->longText('entry_request_body')->nullable()->collation('utf8mb4_general_ci');
                $table->longText('entry_response')->nullable()->collation('utf8mb4_general_ci');
    ...
    {
        Schema::dropIfExists('integrations_payments');
    }
}
