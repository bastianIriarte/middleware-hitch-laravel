...
@section('contenido')
    <div class="card-body p-sm-6">
        <div class="text-center mb-4">
            <h5 class="mb-1"><b>Cambio de Contraseña Requerido</b></h4>
                <hr>
        </div>
        ...
        @php
            $action = route('change-password-required-post');
            $btn_logout = route('logout');
        @endphp
        <div class="row">
            <form action="{{ $action }}" method="POST" id="form">
                ...
                <div class="col-xl-12">
                    ...
                    <p class="mb-0 text-center">
                        <a href="{{ $btn_logout }}" class="btn btn-danger"><i class="fa fa-power-off"></i> Cerrar
                            Sesión</a>
                    </p>
                </div>
            </form>
