    ...
    <div class="flex items-center justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">
                Gestiona usuarios, accesos API y estados.
            </p>
        </div>
                ...
                <tbody class="divide-y">
                    @forelse($list_data as $l)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center text-xs font-semibold">
                ...
                <template x-if="!isEdit">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2" x-data="{ show: false }">
                            ...
                            <div class="flex rounded-lg border border-gray-300 focus-within:ring-2 focus-within:ring-primary-500 focus-within:border-primary-500 bg-white overflow-hidden">
                                <input
                                ...
                                <button
                                    type="button"
                                    class="px-3 text-gray-500 hover:text-gray-700 bg-transparent"
                                    @click="show = !show"
                                >
    ...
    >
        ...
        >
            ...
            <form method="POST" :action="deleteUrl" class="px-6 py-5 space-y-4" x-ref="deleteForm">
                ...
                <div class="bg-yellow-50 border border-yellow-200 text-yellow-800 px-3 py-2 rounded-lg text-sm flex gap-2">
