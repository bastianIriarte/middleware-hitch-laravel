            ...
            <div class="p-6">
                <form method="GET" action="{{ route('file-management.logs') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                        ...
                        <!-- Empresa -->
                        <div>
                            <label for="company_id" class="block text-sm font-semibold text-gray-700 mb-2">Empresa</label>
                        ...
                        <!-- Tipo de archivo -->
                        <div>
                            <label for="file_type_id" class="block text-sm font-semibold text-gray-700 mb-2">Tipo de
                                Archivo</label>
                        ...
                        <div>
                            ...
                            <select id="status" name="status"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white">
                                <option value="">Todos</option>
                                <option value="received" {{ request('status') == 'received' ? 'selected' : '' }}>Recibido
                                </option>
                                <option value="processing" {{ request('status') == 'processing' ? 'selected' : '' }}>
                                    Procesando</option>
                                <option value="uploaded" {{ request('status') == 'uploaded' ? 'selected' : '' }}>Subido
                                </option>
                        ...
                        <!-- Fecha desde -->
                        <div>
                            <label for="date_from" class="block text-sm font-semibold text-gray-700 mb-2">Desde</label>
                        ...
                        <!-- Fecha hasta -->
                        <div>
                            <label for="date_to" class="block text-sm font-semibold text-gray-700 mb-2">Hasta</label>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    @switch($log->status)
                                        ...
                                        @default
                                            <span
                                                class="px-2 py-1 text-xs bg-gray-200 text-gray-700 rounded">{{ $log->status }}</span>
                                    @endswitch
                                </td>
