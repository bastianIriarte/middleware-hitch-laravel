                ...
                <div>
                    ...
                    <select id="file_type_id" name="file_type_id"
                        ...
                        @foreach($fileTypes as $type)
                            <option value="{{ $type->id }}" {{ request('file_type_id') == $type->id ? 'selected' : '' }}>
                                {{ $type->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <table class="min-w-full text-sm text-left">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <strong class="text-gray-900">{{ $error->company->code }}</strong><br>
                            <span class="text-xs text-gray-500">{{ $error->company->name }}</span>
                        </td>

                        <td class="px-4 py-3">{{ $error->fileType->name }}</td>

                        <td class="px-4 py-3">
                            <code class="text-primary-600">{{ $error->error_type }}</code>
                        </td>
                        ...
                        <td class="px-4 py-3">
                            ...
                            @if($error->error_details)
                                ...
                                <span class="text-xs text-gray-500">
                                    {{ Str::limit($error->error_details, 40) }}
                                </span>
                            @endif
                        </td>
