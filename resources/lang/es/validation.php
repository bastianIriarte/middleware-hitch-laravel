...
return [
    ...
    | la clase de validador. Algunas de estas reglas tienen varias versiones,
    ...
    */
    ...
    | la convención "attribute.rule" para nombrar las líneas. Esto facilita especificar
    | una línea de lenguaje personalizada específica para una regla de atributo determinada.
    |
    */
