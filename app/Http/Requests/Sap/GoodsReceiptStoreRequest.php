...
class GoodsReceiptStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'lines.*.WarehouseCode'        => 'required|string|max:8',
            'lines.*.CostingCode'        => 'nullable|string|max:50',
            'lines.*.CostingCode2'       => 'nullable|string|max:50',
            'lines.*.CostingCode3'       => 'nullable|string|max:50',
    ...
    public function messages()
    {
        return [
            ...
            'lines.*.WarehouseCode.required' => 'El código del almacén es obligatorio.',
            'lines.*.WarehouseCode.max'      => 'El código del almacén no debe exceder los 8 caracteres.',
            ...
            'lines.*.CostingCode3.max' => 'El código de area no debe exceder los 50 caracteres.',
