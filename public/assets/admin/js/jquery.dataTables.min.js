...
sNext:"<i class='fa-light fa-angle-right'></i>",sPrevious:"<i class='fa-light fa-angle-left'></i>"},sEmptyTable:"Ningún dato disponible en esta tabla",sInfo:"Mostrando registros del _START_ al _END_ de un total de _TOTAL_ registros",sInfoEmpty:"Mostrando registros del 0 al 0 de un total de 0 registros",sInfoFiltered:"(filtrado de un total de _MAX_ total registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron resultados"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
